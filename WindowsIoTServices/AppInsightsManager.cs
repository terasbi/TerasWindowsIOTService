...
//#endif
            ...
            Client.InstrumentationKey = IoTMainClass.StrInstrumentKey;
            ...
            Client.Context.User.Id = IoTMainClass.StrDeviceId + "-" + Assembly.GetEntryAssembly().GetName().Name.ToString();
